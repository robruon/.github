...
[![Website](https://img.shields.io/badge/Website-robruon.com-blue?style=flat)](https://robruon.com)
&nbsp;
[![Portfolio](https://img.shields.io/badge/Portfolio-dev.robruon.com-purple?style=flat)](https://dev.robruon.com)
...
graph TD
    ...
    R --> LANG["Programming Languages"]
    R --> TRADE["Quantitative Infrastructure"]
    R --> WEB3["Blockchain Protocols"]
    R --> CRYPTO["Cryptographic Systems"]

    LANG --> SL["SL"]
    LANG --> REG["SL Registry"]

    TRADE --> KATS["KATS"]

    WEB3 --> GRAV["Gravitas"]

    CRYPTO --> HX["HXSTG Showcase"]
```
...
<img src="https://github-readme-stats.shion.dev/api/pin/?username=robruon&repo=kats&theme=github_dark&hide_border=true" />
</a>

<a href="https://github.com/robruon/gravitas">
